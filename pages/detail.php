<?php 
    ...
    $id = $_GET['id'];
    $ambil = mysqli_query($koneksi, "SELECT produk.*, produk.id as 'id', produk.nama_produk as 'nama', produk.jumlah as 'stok', produk.harga as harga FROM produk where produk.id = $id");
...
<div class="row container">
        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
            <h5 class="card-title"><?php echo $edit['nama_produk']; ?></h5>
            <p>Stok : <?php echo $edit['jumlah']; ?></p>
            <p>Harga : <?php echo $edit['harga']; ?></p>
